...
export function StarIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 20 20" aria-hidden="true">
      <path d="m10 1.6 2.52 5.1 5.63.82-4.07 3.97.96 5.6L10 14.43l-5.04 2.65.96-5.6L1.85 7.52l5.63-.82L10 1.6z" />
    </svg>
  );
}
...
export function SparkleIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M12 3v4M12 17v4M5 12H1M23 12h-4M6.3 6.3 8.5 8.5M15.5 15.5l2.2 2.2M6.3 17.7l2.2-2.2M15.5 8.5l2.2-2.2" />
    </svg>
  );
}
